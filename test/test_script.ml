...
let sighash_test_vectors = [
  ...
  (* Additional vectors from Bitcoin Core sighash.json for extended coverage *)

  (* Vector 11: input index 3, empty script *)
  ...
  (* Vector 13: negative hash_type with various scripts *)
  ...
  (* Vector 16: multi-byte script, negative hash_type *)
  ...
  (* Vector 17: input index 3 with complex script *)
  ...
  (* Vector 18: longer script with CODESEP *)
  ...
  (* Vector 19: more CODESEP handling *)
  ...
  (* Vector 20: multiple scripts with zeros *)
  ...
  (* Vector 21: another negative hash type edge case *)
  ...
  (* Vector 22: script with OP_0 and codesep patterns *)
  ...
  (* Vector 23: transaction with many inputs *)
  ...
  (* Vector 24: longer script prefix *)
  ...
  (* Vector 25: large script with multiple opcodes *)
  ...
  (* Vector 26: negative hash with 0xab in script *)
  ...
  (* Vector 27: complex input structures *)
  ...
  (* Vector 28: input 3 with abac script *)
  ...
  (* Vector 29: edge case script combinations *)
  ...
  (* Vector 30: script with mixed opcodes *)
